 ...
 * @author isslem
 */
public class TestAhmedController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            for (int i = 0; i < l.size(); i++) {
                ...
                ItemAhmedController item = fxmlLoader.getController();
...
//            }
    ...
    @FXML
    private void selesctitem(MouseEvent event) {
        
        Reclamation rec = new Reclamation(0, 0, 0, null);
